                        ...
                        <tbody>
                            <xsl:for-each select="package">
                                <tr class="text-gray-700 even:bg-gray-50">
                                    ...
                                    <td class="py-2 px-4 border-b"><xsl:value-of select="duration"/></td>
                                    <td class="py-2 px-4 border-b"><xsl:value-of select="departureDate"/></td>
                                    <td class="py-2 px-4 border-b"><xsl:value-of select="destination"/></td>
                                </tr>
                            </xsl:for-each>
                        </tbody>
                    </table>
